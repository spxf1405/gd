...
const (
	...
	Severity_SEVERITY_BLOCKING    Severity = 1
...
type AppError struct {
	...
	Severity      Severity               `protobuf:"varint,2,opt,name=severity,proto3,enum=common.v1.Severity" json:"severity,omitempty"`
...
func (x *AppError) GetSeverity() Severity {
	if x != nil {
		return x.Severity
	}
...
const file_common_v1_errors_proto_rawDesc = "" +
	"\n" +
	"\x16common/v1/errors.proto\x12\tcommon.v1\"U\n" +
	"\bAppError\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12/\n" +
	"\bseverity\x18\x02 \x01(\x0e2\x13.common.v1.SeverityR\bseverity*Q\n" +
	"\bSeverity\x12\x18\n" +
	"\x14SEVERITY_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11SEVERITY_BLOCKING\x10\x01\x12\x14\n" +
	"\x10SEVERITY_WARNING\x10\x02B)Z'backend/internal/gen/common/v1;commonpbb\x06proto3"
...
var file_common_v1_errors_proto_goTypes = []any{
	(Severity)(0),    // 0: common.v1.Severity
	(*AppError)(nil), // 1: common.v1.AppError
}
var file_common_v1_errors_proto_depIdxs = []int32{
	0, // 0: common.v1.AppError.severity:type_name -> common.v1.Severity
