<template>
  <div
    class="relative w-screen h-screen bg-[#060810] flex items-center justify-center overflow-hidden"
  >
    <!-- Grid background -->
    ...
    <!-- Corner decorations -->
    <div
      class="absolute top-4 left-4 border-t border-l border-[#00f0ff] pointer-events-none"
      style="width: 80px; height: 80px"
    />
    <div
      class="absolute top-4 right-4 border-t border-r border-[#ff2d78] pointer-events-none"
      style="width: 80px; height: 80px"
    />
    <div
      class="absolute bottom-4 left-4 border-b border-l border-[#ff2d78] pointer-events-none"
      style="width: 80px; height: 80px"
    />
    <div
      class="absolute bottom-4 right-4 border-b border-r border-[#00f0ff] pointer-events-none"
      style="width: 80px; height: 80px"
    />
    ...
    <ToastProvider swipe-direction="up">
      <ToastRoot
        ...
        :duration="3000"
        class="fixed top-6 left-1/2 -translate-x-1/2 bg-[#060810] border z-[100] text-[12px] px-6 py-3 tracking-[2px] uppercase whitespace-nowrap toast-line data-[state=open]:animate-toast-in data-[state=closed]:animate-toast-out"
        :class="
          toastError
      ...
      <ToastViewport
        class="fixed top-0 left-0 w-full pointer-events-none z-[100]"
      />
    </ToastProvider>
    ...
    <Transition name="card-swap">
      ...
      >
        ...
        <div class="px-10 pt-9 pb-7 border-b border-[#0a2030] relative">
          <p
            class="text-[11px] text-[#00f0ff] tracking-[4px] uppercase mb-3 opacity-70"
          >
            // SYSTEM ACCESS //
          </p>
          <h1
            class="text-[30px] font-bold text-white mb-2 tracking-[2px] leading-tight"
          >
            SIGN <span class="text-[#00f0ff]">IN</span>
          </h1>
          <p class="text-[12px] text-white/50 tracking-[1px]">
        ...
        <div class="px-10 pt-9 pb-8">
          ...
          >
            ...
            <svg
              v-if="isLoading"
              class="w-6 h-6 flex-shrink-0 animate-spin text-[#00f0ff]"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <span
              class="text-[10px] border border-[#0e4060] text-white px-2 py-0.5 tracking-[1px] transition-all duration-200 group-hover:border-[#00f0ff] group-hover:text-[#00f0ff]"
              >ACTIVE</span
            >
          </button>
          ...
          <div class="flex items-center gap-3 my-7">
            ...
            <span class="text-[10px] text-white/20 tracking-[3px]"
              >// MORE OPTIONS //</span
            >
            <div class="flex-1 h-px bg-[#0a1828]" />
          </div>
          ...
          <p class="text-[11px] text-white/50 tracking-[0.5px] leading-[1.8]">
            ...
            <a
              href="#"
              class="text-[#00f0ff] no-underline opacity-60 hover:opacity-100 transition-opacity"
              >Terms of Service</a
            >
            và
            <a
        ...
        <!-- Footer -->
        <div
          class="border-t border-[#0a1828] px-10 py-4 flex justify-between items-center"
        >
          <span class="text-[10px] text-white/20 tracking-[2px]"
            >CORP. NETWORK v2.0.77</span
          >
          <div class="flex items-center gap-2 text-[10px] text-white/20">
            <span
              class="w-[6px] h-[6px] bg-[#00f0ff] rounded-full animate-pulse"
            />
            NODE ACTIVE
          </div>
        </div>
    ...
    <Transition name="card-swap">
      ...
      >
        ...
        <!-- Header -->
        <div
          class="px-10 pt-8 pb-7 border-b border-[#0a2030] relative flex-shrink-0"
        >
          <div
            class="absolute top-9 right-10 text-[10px] text-[#ff2d78] border border-[#ff2d78] px-2.5 py-1 tracking-[2px] opacity-70 font-bold"
          >
            STEP 1/1
          </div>
          <div class="flex items-center gap-5 mb-4">
            <div class="relative flex-shrink-0">
              <div
                class="absolute inset-0 rounded-full bg-[#00f0ff] opacity-[0.08] blur-md scale-125"
              />
              <div
                class="relative w-[60px] h-[60px] rounded-full bg-[rgba(0,240,255,0.06)] border border-[#00f0ff]/30 flex items-center justify-center"
              >
                <div
                  class="absolute -top-[5px] -left-[5px] w-[10px] h-[10px] border-t border-l border-[#00f0ff]/60"
                />
                <div
                  class="absolute -top-[5px] -right-[5px] w-[10px] h-[10px] border-t border-r border-[#00f0ff]/60"
                />
                <div
                  class="absolute -bottom-[5px] -left-[5px] w-[10px] h-[10px] border-b border-l border-[#00f0ff]/60"
                />
                <div
                  class="absolute -bottom-[5px] -right-[5px] w-[10px] h-[10px] border-b border-r border-[#00f0ff]/60"
                />
                <span
                  class="font-orbitron text-[17px] font-bold text-[#00f0ff] select-none"
                  >{{ initials }}</span
                >
              </div>
              <span
                class="absolute bottom-0.5 right-0.5 w-[10px] h-[10px] rounded-full bg-[#00f0ff] border-2 border-[#060810] animate-pulse"
              />
            </div>
            <div>
              <p
                class="text-[11px] text-[#00f0ff]/60 tracking-[2px] uppercase mb-1"
              >
                Xin chào,
              </p>
              <h1
                class="font-orbitron text-[22px] font-bold text-white leading-none tracking-wide"
              >
        ...
        <div class="overflow-y-auto flex-1 onboarding-scroll">
          <!-- Security notice -->
          <div
            class="mx-10 mt-7 border border-[#0a2030] bg-[rgba(0,240,255,0.02)] px-5 py-4 relative"
          >
            <div
              class="absolute top-0 left-0 w-4 h-4 border-t border-l border-[#00f0ff] opacity-50"
            />
            <div
              class="absolute bottom-0 right-0 w-4 h-4 border-b border-r border-[#ff2d78] opacity-50"
            />
            <div class="flex gap-3 items-start">
              <svg
                class="w-4 h-4 text-[#00f0ff] flex-shrink-0 mt-0.5"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="1.5"
              ...
              <p
                class="text-[11px] text-white/50 leading-[1.9] tracking-[0.3px]"
              >
                <span class="text-[#00f0ff] opacity-80">[ BẢO MẬT ]</span>
                Thông tin của bạn được mã hóa và bảo mật tuyệt đối. Hệ thống yêu
                cầu xác minh danh tính thực để
                <span class="text-white/80"
                  >ngăn chặn tài khoản smurf (bịp hạng)</span
                >
                — mỗi người chỉ được phép sở hữu
                <span class="text-[#00f0ff] opacity-80"
                  >một tài khoản duy nhất</span
                >. Khi nhận giải thưởng, CCCD/CMND phải khớp với thông tin đã
                đăng ký, nếu không kết quả sẽ bị hủy.
              </p>
            </div>
          </div>
          ...
          <div class="px-10 pt-7 pb-8 space-y-5">
            ...
            <div>
              ...
              <div class="cp-input-wrap" :class="{ 'is-error': errors.dob }">
                ...
                />
                <svg
                  class="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#00f0ff] opacity-40 pointer-events-none"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="1.5"
              ...
              <p v-if="errors.dob" id="err-dob" role="alert" class="cp-error">
                {{ errors.dob }}
              </p>
            </div>
            ...
            <div>
              ...
              <p
                id="hint-idLast4"
                class="text-[10px] text-white/20 mt-1.5 tracking-[0.5px]"
              >
                Chỉ nhập 4 chữ số cuối — dùng để đối chiếu khi nhận giải
              </p>
            </div>
            ...
            <div>
              ...
              <div class="flex gap-2">
                ...
                >
                  ...
                  <SelectTrigger
                    class="flex-shrink-0 flex items-center gap-2 px-3 min-w-[106px] h-full border transition-all duration-200 cursor-pointer select-none border-[#0e2840] bg-transparent text-white hover:border-[#00f0ff] hover:bg-[rgba(0,240,255,0.02)] focus:outline-none focus:border-[#00f0ff] focus:bg-[rgba(0,240,255,0.02)] data-[state=open]:border-[#00f0ff] data-[state=open]:bg-[rgba(0,240,255,0.02)]"
                  ...
                  >
                    <SelectValue>
                      <span class="flex items-center gap-2 py-[14px]">
                        ...
                        <span
                          class="text-[12px] text-[#00f0ff] font-mono tracking-wider"
                          >{{ currentCountry.dial }}</span
                        >
                      </span>
                    </SelectValue>
                  ...
                  <SelectPortal>
                    <SelectContent
                      position="popper"
                      :side-offset="2"
                      class="w-[200px] bg-[#060c14] border border-[#0e2840] z-[200] shadow-[0_8px_32px_rgba(0,0,0,0.7)] data-[state=open]:animate-select-in data-[state=closed]:animate-select-out will-change-[opacity,transform]"
                    >
                      <SelectViewport>
                        <SelectItem
                          ...
                          :key="c.code"
                          :value="c.code"
                          class="flex items-center gap-3 px-4 py-3 cursor-pointer transition-all duration-150 outline-none text-white/60 hover:bg-[rgba(0,240,255,0.05)] hover:text-white focus:bg-[rgba(0,240,255,0.05)] focus:text-white data-[state=checked]:bg-[rgba(0,240,255,0.06)] data-[state=checked]:text-[#00f0ff]"
                        >
                          <span
                            class="text-[18px] leading-none flex-shrink-0"
                            >{{ c.flag }}</span
                          >
              ...
              <p
                ...
                class="text-[10px] text-white/20 mt-1.5 tracking-[0.5px]"
              >
                <span v-if="currentCountry.code === 'VN'"
                  >9 chữ số (không cần 0 đầu) hoặc 10 số có 0 đầu — VD:
                  912345678</span
                >
                <span v-else
                  >Nhập số theo định dạng quốc tế, không gồm mã quốc gia</span
                >
              </p>
            </div>
            ...
            <div class="pt-3">
              ...
              >
                <span
                  class="absolute inset-0 btn-shimmer opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                />
                <svg
                  v-if="isSubmitting"
        ...
        <!-- Footer -->
        <div
          class="border-t border-[#0a1828] px-10 py-4 flex justify-between items-center flex-shrink-0"
        >
          <span class="text-[10px] text-white/20 tracking-[2px]"
            >IDENTITY PROTOCOL v1.0</span
          >
          <div class="flex items-center gap-2 text-[10px] text-white/20">
            <span
              class="w-[6px] h-[6px] bg-[#00f0ff] rounded-full animate-pulse"
...
const currentCountry = computed(
  () =>
    countryOptions.find((c) => c.code === selectedCountryCode.value) ??
    countryOptions[0],
);
...
function onIdInput(e: Event) {
  form.value.idLast4 = (e.target as HTMLInputElement).value
    .replace(/\D/g, "")
    .slice(0, 4);
}
...
function validateField(field: keyof typeof errors.value) {
  ...
  if (field === "fullName") {
    if (!form.value.fullName.trim())
      ...
      errors.value.fullName = "⚠ Họ tên quá ngắn";
  }
  ...
  if (field === "dob") {
    if (!form.value.dob) {
      ...
      const age =
        (Date.now() - new Date(form.value.dob).getTime()) /
  ...
  if (field === "idLast4") {
    if (!form.value.idLast4)
      errors.value.idLast4 = "⚠ Vui lòng nhập 4 số cuối CCCD";
    else if (!/^\d{4}$/.test(form.value.idLast4))
      errors.value.idLast4 = "⚠ Phải là đúng 4 chữ số";
  }
  ...
  if (field === "phone") {
    if (!form.value.phone) {
      ...
      if (!vn9 && !vn10)
        errors.value.phone =
          "⚠ Số VN không hợp lệ — VD: 912345678 hoặc 0912345678";
    } else {
      if (form.value.phone.length < 5)
        errors.value.phone = "⚠ Số quốc tế quá ngắn";
    }
  }
}
...
.onboarding-scroll {
  ...
  scrollbar-color: #0e2840 transparent;
}
...
/* ── Date picker ── */
.cp-date::-webkit-calendar-picker-indicator {
  opacity: 0;
  cursor: pointer;
  position: absolute;
  right: 0;
...
.cp-date::-webkit-datetime-edit-fields-wrapper {
  color: white;
}
...
[data-state="open"].animate-select-in {
  animation: selectIn 0.15s ease forwards;
}
[data-state="closed"].animate-select-out {
  animation: selectOut 0.12s ease forwards;
}
