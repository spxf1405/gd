...
defineExpose({ isFilterActive, doesFilterPass, onApply, onClear });
</script>
    ...
    <div class="px-3 py-3 flex flex-col gap-2">
      ...
      <template v-else>
        <div class="flex flex-col gap-1">
          <span class="text-[10px] font-semibold tracking-[0.08em] uppercase text-[#5a6475] px-1">Từ ngày</span>
          <CalendarPicker v-model="dateFrom">
            <template #trigger>
              <div
                class="flex items-center gap-2 px-3 py-2 w-full cursor-pointer rounded-[10px] bg-white/[0.04] border border-white/[0.07] transition-all duration-150 hover:bg-white/[0.07] hover:border-white/[0.12]"
        ...
        <div class="flex items-center gap-2 px-1">
          ...
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" class="text-[#5a6475]">
            <path
        ...
        <div class="flex flex-col gap-1">
          <span class="text-[10px] font-semibold tracking-[0.08em] uppercase text-[#5a6475] px-1">Đến ngày</span>
